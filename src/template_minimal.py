...
_TEMPLATE = (
    ...
    ("layout.dashboard.stats-place.visible", False),
    ("layout.dashboard.stats-place.append", True),
    ("layout.dashboard.stats-media.visible", False),
    ("layout.dashboard.stats-media.append", True),
    ("layout.dashboard.stats-note.visible", False),
    ("layout.dashboard.stats-note.append", True),
    ("layout.dashboard.stats-tag.visible", False),
    ("layout.dashboard.stats-tag.append", True),
    ("layout.dashboard.stats-bookmark.visible", False),
