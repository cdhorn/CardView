...
class PersonProfilePage(BaseProfilePage):
    ...
    def page_panel(self, configdialog):
        ...
        configdialog.add_checkbox(
            ...
            1, "options.person.page.pinned-header",
        ...
        configdialog.add_checkbox(
            ...
            9, "options.person.page.use-smaller-detail-font",
        ...
        configdialog.add_spinner(
            ...
            10, "options.person.page.border-width",
            (0, 5),
        )
        configdialog.add_checkbox(
            grid, _("Enable coloring schemes"),
            11, "options.person.page.use-color-scheme",
        ...
        configdialog.add_checkbox(
            ...
            13, "options.person.page.sort-tags-by-name",
        ...
        configdialog.add_checkbox(
            ...
            14, "options.person.page.include-child-notes",
        ...
        configdialog.add_checkbox(
            ...
            15, "options.person.page.enable-warnings",
        ...
        configdialog.add_checkbox(
            ...
            16, "options.person.page.enable-tooltips",
