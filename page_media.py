...
class MediaProfilePage(BaseProfilePage):
    ...
    def render_page(self, header, vbox, media):
        ...
        if self.config.get("preferences.profile.media.layout.pinned-header"):
    ...
    def layout_panel(self, configdialog):
        ...
        configdialog.add_checkbox(
            ...
            2, "preferences.profile.media.layout.pinned-header",
        ...
        configdialog.add_checkbox(
            ...
            7, "preferences.profile.media.layout.use-smaller-detail-font",
        ...
        configdialog.add_spinner(
            ...
            8, "preferences.profile.media.layout.border-width",
            (0, 5),
        )
        configdialog.add_checkbox(
            grid, _("Enable coloring schemes"),
            9, "preferences.profile.media.layout.use-color-scheme",
        ...
        configdialog.add_checkbox(
            ...
            10, "preferences.profile.media.layout.right-to-left",
        ...
        configdialog.add_checkbox(
            ...
            11, "preferences.profile.media.layout.sort-tags-by-name",
        ...
        configdialog.add_checkbox(
            ...
            13, "preferences.profile.media.layout.enable-warnings",
        ...
        configdialog.add_checkbox(
            ...
            14, "preferences.profile.media.layout.enable-tooltips",
        ...
        reset = ConfigReset(configdialog, self.config, "preferences.profile.media.layout", defaults=self.defaults, label=_("Reset Page Defaults"))
    ...
    def active_panel(self, configdialog):
        ...
        configdialog.add_combo(
            ...
            4, "preferences.profile.media.active.tag-format",
            TAG_DISPLAY_MODES
        )
        configdialog.add_spinner(
    ...
    def sources_panel(self, configdialog):
        ...
        configdialog.add_combo(
            ...
            1, "preferences.profile.media.source.image-mode",
            IMAGE_DISPLAY_MODES,
        )        
        configdialog.add_combo(
            grid, _("Tag display mode"),
            2, "preferences.profile.media.source.tag-format",
            TAG_DISPLAY_MODES,
        )
        configdialog.add_spinner(
            grid, _("Maximum tags per line"),
            3, "preferences.profile.media.source.tag-width",
            (1, 20),
        )
