...
CONFIGSETTINGS = (
    ...
    ######################################################################
    # Layout
    ("preferences.profile.family.layout.enable-tooltips", True),
    ...
    ("preferences.profile.family.layout.sort-tags-by-name", False),
    ("preferences.profile.family.layout.include-child-notes", False),
    ("preferences.profile.family.layout.right-to-left", False),
    # Active Family
