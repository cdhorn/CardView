...
class CitationProfilePage(BaseProfilePage):
    ...
    def render_page(self, header, vbox, citation):
        ...
        if self.config.get("preferences.profile.citation.layout.show-media"):
        ...
        if self.config.get("preferences.profile.citation.layout.show-notes"):
        ...
        if self.config.get("preferences.profile.citation.layout.show-notes") and notes:
            body.pack_start(notes_box, True, True, 0)
        if self.config.get("preferences.profile.citation.layout.show-media") and media:
        ...
        if self.config.get("preferences.profile.citation.layout.pinned-header"):
    ...
    def layout_panel(self, configdialog):
        ...
        configdialog.add_checkbox(
            ...
            1, "preferences.profile.citation.layout.show-notes",
        )
        configdialog.add_checkbox(
            grid, _("Show associated media"),
            2, "preferences.profile.citation.layout.show-media",
        )        
        configdialog.add_checkbox(
            grid, _("Pin active source header so it does not scroll"),
            3, "preferences.profile.citation.layout.pinned-header",
        ...
        configdialog.add_checkbox(
            ...
            7, "preferences.profile.citation.layout.use-smaller-detail-font",
        ...
        configdialog.add_spinner(
            ...
            8, "preferences.profile.citation.layout.border-width",
            (0, 5),
        )
        configdialog.add_checkbox(
            grid, _("Enable coloring schemes"),
            9, "preferences.profile.citation.layout.use-color-scheme",
        ...
        configdialog.add_checkbox(
            ...
            10, "preferences.profile.citation.layout.right-to-left",
        ...
        configdialog.add_checkbox(
            ...
            11, "preferences.profile.citation.layout.sort-tags-by-name",
        ...
        configdialog.add_checkbox(
            ...
            12, "preferences.profile.citation.layout.include-child-notes",
        ...
        configdialog.add_checkbox(
            ...
            13, "preferences.profile.citation.layout.enable-warnings",
        ...
        configdialog.add_checkbox(
            ...
            14, "preferences.profile.citation.layout.enable-tooltips",
        ...
        reset = ConfigReset(configdialog, self.config, "preferences.profile.citation.layout", defaults=self.defaults, label=_("Reset Page Defaults"))
