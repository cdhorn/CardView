...
class EventProfilePage(BaseProfilePage):
    ...
    def render_page(self, header, vbox, event):
        ...
        if self.config.get("preferences.profile.event.page.show-notes"):
        ...
        if self.config.get("preferences.profile.event.page.show-media"):
    ...
    def layout_panel(self, configdialog):
        ...
        configdialog.add_checkbox(
            ...
            1, "preferences.profile.event.page.show-notes",
        )        
        configdialog.add_checkbox(
            grid, _("Show associated media"),
            2, "preferences.profile.event.page.show-media",
        )        
        configdialog.add_checkbox(
        ...
        configdialog.add_checkbox(
            ...
            10, "preferences.profile.event.page.right-to-left",
