...
from frame_selectors import AttributeSelector, FrameFieldSelector
from frame_utils import ConfigReset
...
class BaseProfilePage(Callback):
    ...
    def create_grid(self):
        ...
        """
        grid = Gtk.Grid(
            row_spacing=6, column_spacing=6, column_homogeneous=False
        )
        grid.set_border_width(12)
        return grid

    def _config_facts_fields(
        self,
        configdialog,
        grid,
        space,
    ...
    def _config_metadata_attributes(
        self, grid, space, start_row, start_col=1, number=8, obj_type="Person"
    ):
        """
    ...
    def _config_global_options(
        self, configdialog, grid, start_row, start_col=1
    ):
        """
    ...
    def _media_panel(self, configdialog, space):
        ...
        self._config_metadata_attributes(
            grid,
            "{}.media".format(space),
            16,
            start_col=1,
    ...
    def color_panel(self, configdialog):
        ...
        color_list = [
            ...
            (
                bg_very_high_text,
                "options.colors.confidence.very-high",
                1,
                1,
                "Confidence",
            ),
            (
                bg_high_text,
                "options.colors.confidence.high",
                2,
                1,
                "Confidence",
            ),
            (
                bg_normal_text,
                "options.colors.confidence.normal",
                3,
                1,
                "Confidence",
            ),
            ...
            (
                bg_very_low_text,
                "options.colors.confidence.very-low",
                5,
                1,
                "Confidence",
            ),
            (
                brd_very_high_text,
                "options.colors.confidence.border-very-high",
                1,
                4,
                "Confidence",
            ),
            (
                brd_high_text,
                "options.colors.confidence.border-high",
                2,
                4,
                "Confidence",
            ),
            (
                brd_normal_text,
                "options.colors.confidence.border-normal",
                3,
                4,
                "Confidence",
            ),
            (
                brd_low_text,
                "options.colors.confidence.border-low",
                4,
                4,
                "Confidence",
            ),
            (
                brd_very_low_text,
                "options.colors.confidence.border-very-low",
                5,
                4,
                "Confidence",
            ),
            ...
            (
                bg_daughter,
                "options.colors.relations.daughter",
                8,
                1,
                "Relation",
            ),
            ...
            (
                brd_active,
                "options.colors.relations.border-active",
                1,
                4,
                "Relation",
            ),
            (
                brd_spouse,
                "options.colors.relations.border-spouse",
                2,
                4,
                "Relation",
            ),
            (
                brd_father,
                "options.colors.relations.border-father",
                3,
                4,
                "Relation",
            ),
            (
                brd_mother,
                "options.colors.relations.border-mother",
                4,
                4,
                "Relation",
            ),
            (
                brd_brother,
                "options.colors.relations.border-brother",
                5,
                4,
                "Relation",
            ),
            (
                brd_sister,
                "options.colors.relations.border-sister",
                6,
                4,
                "Relation",
            ),
            ...
            (
                brd_daughter,
                "options.colors.relations.border-daughter",
                8,
                4,
                "Relation",
            ),
            (
                brd_none,
                "options.colors.relations.border-none",
                9,
                4,
                "Relation",
            ),
            ...
            (
                brd_religious,
                "options.colors.events.border-religious",
                3,
                4,
                "Event",
            ),
            (
                brd_vocational,
                "options.colors.events.border-vocational",
                4,
                4,
                "Event",
            ),
            (
                brd_academic,
                "options.colors.events.border-academic",
                5,
                4,
                "Event",
            ),
            ...
            (
                brd_residence,
                "options.colors.events.border-residence",
                8,
                4,
                "Event",
            ),
